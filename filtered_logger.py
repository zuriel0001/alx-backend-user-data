#!/usr/bin/env python3
"""
Model that uses regex in replacing occurrences
...
class RedactingFormatter(logging.Formatter):
    """
    Represent redacting Formatter class
    """
...
def filter_datum(fields: List[str], redaction: str, message: str,
                 separator: str) -> str:
    """Method that returns regex obfuscated log messages"""
    for field in fields:
...
def main() -> None:
    """
    Method to obtain database connection using get_db
